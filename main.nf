...
process Fit_MRDS {
    ...
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Diff_V0_COMP_SIZE.nii.gz"
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Diff_V0_EIGENVALUES.nii.gz"
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Diff_V0_ISOTROPIC.nii.gz"
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Diff_V0_MSE.nii.gz"
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Diff_V0_NUM_COMP.nii.gz"
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Diff_V0_PDDs_CARTESIAN.nii.gz"
    ...
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Equal_V0_COMP_SIZE.nii.gz"
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Equal_V0_EIGENVALUES.nii.gz"
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Equal_V0_ISOTROPIC.nii.gz"
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Equal_V0_MSE.nii.gz"
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Equal_V0_NUM_COMP.nii.gz"
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Equal_V0_PDDs_CARTESIAN.nii.gz"
    ...
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Fixed_V0_COMP_SIZE.nii.gz"
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Fixed_V0_EIGENVALUES.nii.gz"
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Fixed_V0_ISOTROPIC.nii.gz"
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Fixed_V0_MSE.nii.gz"
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Fixed_V0_NUM_COMP.nii.gz"
    ${params.use_isotropic ? 'file' : '//file'} "${sid}__MRDS_Fixed_V0_PDDs_CARTESIAN.nii.gz"
